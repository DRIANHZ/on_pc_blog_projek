        ...
        <?php foreach ($datas as $data) : ?>
            <tbody>
                ...
                <td>
                    ...
                    <a href="other_profile.php?id=<?= $data['user_id'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
